...
router.post('/electronic-devices/item/:id/update', elecDevicesController.post_elec_device_update);
...
router.post('/phones/item/:id/update', phonesController.post_phone_update);
